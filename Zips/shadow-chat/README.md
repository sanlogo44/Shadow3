...
>
> Bekannte Grenze: Benutzername, E-Mail, Rolle und Einstellungen werden als lesbare Metadaten in SQLite geführt (nicht feldweise verschlüsselt). Passwörter sind Argon2id-gehasht, der Kill-Switch als SHA-256-Hash gespeichert, Chat-Inhalte AES-256-GCM verschlüsselt. Eine feldweise Verschlüsselung der Metadaten ist als künftige Erweiterung vorgesehen.
...
# API-Server starten (Standard: 127.0.0.1:8787). Binary heißt `shadow`:
./target/release/shadow server --port 8787 --data-dir ./shadow-data
